...
require.define("/index.js",function(b,h){var e=new (b("events").EventEmitter),f=function(c){function a(a){for(var b in c)childListener[b]||(a[b]=c[b]);return f(a)}c||(c={});var b=function(){var a=Array.apply(null,arguments);c.callback&&c.callback.apply(this,a);c.handle?c.handle.apply(c,a):(err=a.shift())?c.error.call(this,err):c.success&&c.success.apply(this,a)};b.listeners=c;b.done=function(a){return a.callback(a)};b.handle=function(b){return a({handle:b})};b.callback=function(b){return a({callback:b})};
b.success=function(b){return a({success:b})};b.error=function(b){return a({error:b})};if(!c.error)c.error=function(a){if(!e.emit("unhandledError",a)&&!c.callback)throw a;};return b};h.exports=function(b){return f(b)};h.exports.on=function(){e.on.apply(e,arguments)};h.exports.chain=f;var d=f();Object.keys(d).forEach(function(b){h.exports[b]=function(){var a=f();return a[b].apply(a,arguments)}})});require("/index.js");
